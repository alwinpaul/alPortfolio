...
import alwinLogo from "./../../public/img/logo-no-background.svg"
  ...
  return (
    <div className="h-16">
      ...
      >
        {({ open, close }) => (
          <>
            <div className="mx-auto h-16 px-4 sm:px-8 lg:px-28 xl:px-0 xl:w-9/12">
              <div className="relative flex h-full items-center justify-between lg:justify-between">
                {/* Logo */}
                <div className="w-10 h-10">
                  <Image src={alwinLogo} alt="logo" className="w-full h-full" />
                </div>
                {/* links for desktop */}
                <NavLinks />
                {/* Mobile menu button */}
